...
/* TAB STYLING GELAP */
.stTabs [data-baseweb="tab-list"] { background-color: rgba(30, 41, 59, 0.9) !important; border-radius: 12px; padding: 4px; gap: 4px; border-bottom: none !important; }
...
.ai-panel-header {
    ...
    padding: 16px; border-radius: 12px 12px 0 0; margin-bottom: 15px; display: flex; align-items: center; gap: 10px; border: 1px solid #334155;
}
.chat-action-btn {
    display: inline-flex; align-items: center; justify-content: center; padding: 8px 12px; background: rgba(30, 41, 59, 0.6); color: #94A3B8; border-radius: 8px; font-size: 0.85rem; font-weight: 600; border: 1px solid #334155; transition: all 0.2s; cursor: pointer; width: 100%;
}
...
if not st.session_state.logged_in:
    ...
    with col2:
        st.markdown("<div style='text-align:center; padding:50px 0; background-color: rgba(30, 41, 59, 0.8); border-radius: 15px; border: 1px solid rgba(56, 189, 248, 0.5); backdrop-filter: blur(10px); margin-top: 50px; box-shadow: 0 0 20px rgba(0,0,0,0.5);'><h1 class='gradient-text'>IDX PRO TERMINAL</h1><p class='text-muted' style='letter-spacing:2px; margin-top:5px;'>INSTITUTIONAL QUANT SUITE</p></div>", unsafe_allow_html=True)
